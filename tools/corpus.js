...
export const CORPUS = [
  ...
  // 五音音階。3度の跳躍とその埋め戻しが交互に来るのが癖。
  {
    ...
    region: 'korean',
    meter: '9/8',
    // 経토리(솔ラドレミ)。後半は솔から도'へ完全4度で跳び上がって降りてくる。
    // この4度跳躍がこの旋法の顔なので、順次に均してはいけない。
    notes: [
      n(5, 1), n(6, 0.5), n(8, 1.5), n(9, 1), n(8, 0.5), n(6, 1), n(5, 1.5),
      n(5, 0.5), n(8, 1), n(6, 1), n(5, 1), n(6, 1), n(5, 1), n(3, 1), n(1, 2),
    ],
  },
  {
    ...
    notes: [
      ...
      n(5, 2), n(3, 1), n(5, 1), n(8, 1), n(6, 1), n(5, 1), n(3, 1), n(1, 2),
    ],
  },
  {
    ...
    meter: '9/8',
    notes: [
      n(5, 1), n(5, 0.5), n(6, 0.5), n(8, 1), n(9, 1), n(8, 1), n(6, 1),
      n(5, 2), n(5, 1), n(8, 1), n(6, 1), n(5, 1), n(3, 1), n(2, 1), n(1, 2),
    ],
  },
  {
    id: 'trad-saeya-saeya',

...
export const PARAM_DEFS = [
  ...
  { key: 'composerEngine', group: 'compose', label: 'param.composerEngine', type: 'choice', apply: 'next', ui: true, code: 'ce',
    hint: 'hint.composerEngine', def: 'codex8',
    options: [['codex', 'opt.engine.codex'], ['claude', 'opt.engine.claude'], ['codex2', 'opt.engine.codex2'], ['codex3', 'opt.engine.codex3'], ['codex4', 'opt.engine.codex4'], ['codex5', 'opt.engine.codex5'], ['codex6', 'opt.engine.codex6'], ['codex7', 'opt.engine.codex7'], ['codex8', 'opt.engine.codex8']] },
];
